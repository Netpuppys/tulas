...
const TextBanner = ({ filledText }) => {
  ...
  return (
    <div className="w-screen h-screen flex items-center justify-center bg-transparent">
      <p 
        style={filledText? { color: "#ffffff", textShadow: "0px 0.83px 8.295px rgba(0, 0, 0, 0.40)" } : { color: "transparent", WebkitTextStrokeColor: "#fff", WebkitTextStrokeWidth: "0.1px" }}
        className="font-[TTChocolatesbold] text-center text-[6rem] font-black tracking-[0.10369rem]  leading-[2.38494rem]"
      >
        EXPLORE MORE
        <span className="text-[7rem] block leading-[7.64388rem]">
          Sports
        </span>
      </p>
    </div>
