...
export const semesterData = [
  ...
  },
  {
    ...
    subjects: [
      { subject_code: "AHT 006", subject_name: "Advanced Applied Mathematics" },
      { subject_code: "AHT 008", subject_name: "Universal Human Values" },
      { subject_code: "CET 001", subject_name: "Construction Material" },
      { subject_code: "CET 002", subject_name: "Surveying" },
      { subject_code: "CET 003", subject_name: "Strength of material" },
      { subject_code: "CEP 001", subject_name: "Construction Material" },
      { subject_code: "CEP 002", subject_name: "Surveying" },
      { subject_code: "CEP 003", subject_name: "Strength of material" },
      { subject_code: "CEP 004", subject_name: "Internship-I/Mini Project-I" },
      { subject_code: "SCT 005", subject_name: "Python Programming" },
    ],
  },
  {
