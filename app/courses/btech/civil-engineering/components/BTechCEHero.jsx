    ...
    <>
      ...
      <section className="cl-mbaibh-hero">
        <div className="cl-mbaibh-bg">
          <img src="/courses/btech/civil-engineering/departmentalMission.png" alt="MBA International Business at Tulas Institute"/>
        </div>
        ...
        <div className="cl-mbaibh-inner">
          ...
          <div className="cl-mbaibh-badge">BTECH · Civil Engineering · NAAC A+</div>
          <h1 className="cl-mbaibh-h1">Build The<br/><em>Infrastructure Of Tomorrow</em></h1>
          <p className="cl-mbaibh-desc">Design, build, and sustain the infrastructure of tomorrow — the Department of Civil Engineering at Tulas University combines structural analysis, geotechnical and environmental engineering, and transportation systems with hands-on labs, live projects, and industrial visits.</p>
