...
const PILLS = [
  ...
  { bold: 'Hands-On',     rest: ' Cyber Labs'               },
  { bold: null,            rest: 'Industry Certifications'   },
  { bold: null,            rest: 'Capture-The-Flag Training' },
  { bold: 'Up to ₹60 LPA',rest: ' Highest Package'         },
];

export default function CyberSecHero() {
  return (
    <>
      <style dangerouslySetInnerHTML={{__html:`
        @keyframes cl-cys-zoom{from{transform:scale(1)}to{transform:scale(1.08)}}
        .cl-cys-bg img{width:100%;height:100%;object-fit:cover;animation:cl-cys-zoom 20s ease-in-out infinite alternate}
      `}} />
      ...
      >
        {/* Background image */}
        <div className="cl-cys-bg absolute inset-0 z-0">
          <img src="/courses/btech/computer-science-engineering-cyber-security/bannerImg.webp" alt="Cyber Security at Tulas" />
        </div>
        ...
        <div className="relative z-[5] text-center py-[50px] px-[7%] max-w-[1200px] w-full">
          ...
          >
            Home / Programs / B.Tech / <span style={{ color: '#FFF3D7' }}>Cyber Security</span>
          </div>
          ...
          >
            Study Cyber Security at Tulas and gain expertise in ethical hacking, network defense, digital forensics, cloud security and threat intelligence — through a hands-on, industry-aligned curriculum.
          </p>
