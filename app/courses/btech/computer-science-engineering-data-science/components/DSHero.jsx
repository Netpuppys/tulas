  ...
  return (
    <>
      <style dangerouslySetInnerHTML={{__html:`
        @keyframes cl-ds-zoom{from{transform:scale(1)}to{transform:scale(1.08)}}
        .cl-ds-bg img{width:100%;height:100%;object-fit:cover;animation:cl-ds-zoom 20s ease-in-out infinite alternate}
      `}} />
      ...
      >
        {/* Background image */}
        <div className="cl-ds-bg absolute inset-0 z-0">
          <img src="/courses/btech/computer-science-engineering-data-science/bannerImg.webp" alt="Data Science at Tulas" />
        </div>
        ...
        <div className="relative z-[5] text-center py-[50px] px-[7%] max-w-[1200px] w-full">
          ...
          >
            Home / Programs / B.Tech / <span style={{ color: '#FFF3D7' }}>Data Science</span>
          </div>
          ...
          {/* Subtitle */}
          <p
            className="text-[1.14rem] leading-[1.9] max-w-[840px] mx-auto mb-[30px]"
            style={{ color: 'rgba(255,255,255,.92)' }}
          >
            Study Data Science at Tulas and gain expertise in machine learning, big data analytics, statistical modelling, artificial intelligence and data engineering — through an AI-integrated, industry-aligned curriculum.
          </p>
