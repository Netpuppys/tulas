...
export default function DiplomaCivilHero() {
  return (
    <>
      ...
      <section className="cl-dipce-hero-sec">
        <img src="/diploma-in-civil-engineering/departmentalVision.png" alt="Diploma in Civil Engineering" className="cl-dipce-hero-img"/>
        <div className="cl-dipce-hero-overlay"/>
        <div className="cl-dipce-hero-inner">
          <div className="cl-dipce-hero-badge">Diploma · Civil Engineering · Best Engineering Institute In North India</div>
          <h1 className="cl-dipce-hero-h1">Build The<br/><em>Infrastructure Of Tomorrow</em></h1>
