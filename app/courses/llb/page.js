...
import BannerImg from "../../../public/courses/bba/bannerImg.webp";
...
function MCA() {
  return (
    <>
      <head>
        <title>
          Best Private LLB College in Dehradun, Uttarakhand | Tula's Institute
        </title>
        <meta
          name="description"
          content="Tula's Institute is one of the Best LLB College in Dehradun, Uttarakhand, India that provides valuable educational practices to its students with the help of experienced faculty."
        />
      </head>
      <body>
        <Navbar />
