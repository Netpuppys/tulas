...
const PILLS = [
  { bold: '2-Year',          rest: ' MCA Program'           },
  { bold: 'AI-First',       rest: ' Curriculum'            },
  { bold: null,             rest: 'Live AI Projects'        },
  { bold: null,             rest: 'Industry Certifications' },
  { bold: null,             rest: 'Research & Innovation'   },
  { bold: 'Up to ₹60 LPA', rest: ' Highest Package'        },
];

export default function MCAMLHero() {
  return (
    <>
      <style dangerouslySetInnerHTML={{__html:`
        @keyframes cl-mml-zoom{from{transform:scale(1)}to{transform:scale(1.08)}}
        .cl-mml-bg img{width:100%;height:100%;object-fit:cover;animation:cl-mml-zoom 20s ease-in-out infinite alternate}
      `}} />
      ...
      >
        {/* Background image */}
        <div className="cl-mml-bg absolute inset-0 z-0">
          <img src="/courses/mca/departmentMission.webp" alt="MCA Artificial Intelligence & Machine Learning at Tulas" />
        </div>
