...
export const content = (
  <>
    AI-Integrated MBA | NBA Accredited Program | Industry-Aligned Curriculum | Future-Ready Marketing Professionals
    <br />
    <br />
   The marketing landscape has transformed dramatically with the rise of digital platforms, data-driven decision-making, Artificial Intelligence, and evolving consumer behavior. Today's businesses need marketers who can combine creativity with analytics, storytelling with strategy, and technology with customer engagement.
    <br />
    <br />
    The MBA in Digital Marketing at Tula's Institute, Dehradun is designed to prepare students for the rapidly evolving digital economy. This AI-Integrated MBA program equips learners with cutting-edge marketing skills, enabling them to leverage AI-powered tools for content creation, consumer insights, campaign optimization, audience targeting, automation, and performance analytics.
    <br />
    <br />
   Through practical learning, live projects, industry exposure, internships, and real-world campaigns, students develop the expertise required to build brands, drive customer engagement, and deliver measurable business growth across digital channels.
    <br />
    ...
    <br />
 The MBA in Digital Marketing provides a comprehensive understanding of modern marketing strategies, digital technologies, consumer psychology, branding, and business growth. The program focuses on developing professionals who can create impactful marketing campaigns, analyze customer behavior, optimize digital performance, and lead marketing initiatives in a technology-driven world.
    <br />
    <br />
    Students gain expertise in:
      ...
      <li>
        ...
        <p
            ...
            style={{ fontSize: 'clamp(1.3rem, 3vw, 1.2rem)' }}
          >
            Become the Marketing Leaders of the Digital Era
          </p>
    <br />
Build the strategic mindset, creative expertise, analytical capabilities, and AI-powered marketing skills needed to thrive in a constantly evolving digital landscape with the MBA in Digital Marketing at Tula's Institute, Dehradun—a future-focused program designed for the next generation of marketing innovators, brand builders, and growth leaders.
    <br />
  </>
);
export const items = [
  ...
  },
  {
    ...
    description: [
      "PO1: Marketing Knowledge Application - Apply marketing principles, business concepts, and strategic frameworks to solve real-world business challenges.",
      "PO2: Analytical & Critical Thinking - Analyze market trends, consumer behavior, and campaign performance to make data-driven decisions.",
      "PO3: Strategic Decision-Making - Develop and implement effective marketing strategies aligned with organizational goals.",
      "PO4: Leadership & Team Management - Lead marketing teams and manage projects effectively in dynamic business environments.",
      "PO5: Technology Integration - Utilize digital technologies, AI tools, and marketing platforms to enhance business performance.",
      "PO6: Ethical & Responsible Marketing - Demonstrate ethical practices and responsible decision-making in marketing communications.",
      "PO7: Communication Excellence - Create impactful marketing messages and communicate effectively with diverse audiences.",
      "PO8: Global Marketing Perspective - Understand digital marketing trends and consumer dynamics in national and international markets.",
    ],
    image: Program,
  },
  {
    ...
    description: [
      "PSO1: Digital Strategy Development - Design and execute integrated digital marketing strategies to achieve business objectives.",
      "PSO2: Consumer Engagement & Brand Building - Develop campaigns that enhance customer engagement, brand awareness, and brand loyalty.",
      "PSO3: Performance Marketing Expertise - Plan, execute, and optimize paid marketing campaigns across digital platforms.",
      "PSO4: Marketing Analytics & Insights - Analyze marketing data and customer behavior to improve campaign effectiveness and business outcomes.",
      "PSO5: AI-Powered Marketing Applications - Leverage Artificial Intelligence for content generation, audience targeting, predictive analytics, automation, and campaign optimization.",
      "PSO6: E-Commerce & Digital Growth - Develop strategies for online business growth, customer acquisition, and digital customer experience management.",
    ],
    image: Course,
  },
