...
export const content = (
  <>
    AI-Integrated MBA | NBA Accredited Program | Industry-Aligned Curriculum | Future-Ready Marketing Leaders
    <br />
    <br />
   In today's competitive business environment, marketing is no longer just about promoting products—it's about understanding consumers, creating meaningful experiences, building powerful brands, and driving sustainable business growth. Organizations seek professionals who can combine strategic thinking, creativity, data analytics, and technology to influence markets and customer decisions.
    <br />
    <br />
    The MBA in Marketing at Tula's Institute, Dehradun is designed to develop dynamic marketing professionals equipped to navigate modern business challenges. This AI-Integrated MBA program blends traditional marketing principles with emerging technologies, enabling students to leverage Artificial Intelligence for consumer insights, market research, customer engagement, campaign optimization, and strategic decision-making.
    <br />
    <br />
   Through industry exposure, live projects, case studies, internships, and experiential learning, students gain practical knowledge and leadership skills required to succeed across diverse industries and business functions.
    <br />
    ...
    <br />
 The MBA in Marketing equips students with a comprehensive understanding of marketing strategy, consumer behavior, branding, sales management, market research, and business growth. The program focuses on developing professionals who can identify market opportunities, build strong customer relationships, and create impactful marketing strategies in an increasingly digital and competitive world.
    <br />
    <br />
    Students gain expertise in:
      ...
      <li>
        ...
        <p
            ...
            style={{ fontSize: 'clamp(1.3rem, 3vw, 1.2rem)' }}
          >
            Become the Marketing Leaders of the Tomorrow
          </p>
    <br />
Build the strategic vision, customer-centric mindset, leadership capabilities, and AI-powered marketing expertise needed to create impactful brands and drive business success with the MBA in Marketing at Tula's Institute, Dehradun—a future-focused program designed for aspiring marketers, innovators, and business leaders.
    <br />
  </>
);
export const items = [
  {
    ...
    image: USP,
    points: [
      "AI-Integrated Marketing Curriculum - Learn how AI is transforming content creation, customer segmentation, marketing automation, predictive analytics, and campaign optimization.",
  ...
  },
  {
    ...
    description: [
      "PO1: Marketing Knowledge Application - Apply marketing concepts, business principles, and strategic frameworks to solve organizational challenges.",
      "PO2: Analytical & Critical Thinking - Evaluate market trends, consumer insights, and business data to support informed decision-making",
      "PO3: Strategic Decision-Making - Develop effective marketing strategies that drive customer acquisition, retention, and business growth.",
      "PO4: Leadership & Team Management - Demonstrate leadership capabilities while managing teams, projects, and organizational objectives.",
      "PO5: Technology Integration - Utilize AI tools, analytics platforms, and emerging technologies to enhance marketing effectiveness.",
      "PO6: Ethical & Responsible Marketing - Apply ethical principles and socially responsible practices in marketing and business decisions.",
      "PO7: Communication Excellence - Communicate ideas, strategies, and business recommendations effectively to stakeholders.",
      "PO8: Global Marketing Perspective - Understand changing market dynamics and consumer behavior in domestic and international business environments.",
    ],
    image: Program,
  },
  {
    ...
    description: [
      "PSO1: Strategic Marketing Planning - Develop and implement marketing strategies aligned with organizational goals and market opportunities.",
      "PSO2: Brand Building & Management - Create, position, and manage brands that deliver long-term customer value and competitive advantage.",
      "PSO3: Consumer & Market Insights - Analyze consumer behavior and market trends to support effective business decision-making.",
      "PSO4: Sales & Customer Relationship Management - Design strategies that improve customer acquisition, engagement, retention, and lifetime value.",
      "PSO5: Marketing Analytics & AI Applications - Leverage Artificial Intelligence, business analytics, and data-driven insights to optimize marketing performance.",
      "PSO6: Business Growth & Market Expansion - Identify growth opportunities and develop innovative solutions for market penetration and expansion.",
    ],
    image: Course,
  },
