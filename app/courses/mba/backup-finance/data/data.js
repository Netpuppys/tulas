...
export const content = (
  <>
    AI-Integrated MBA | NBA Accredited Program | Industry-Aligned Curriculum | Future-Ready Finance Professionals
    <br />
    <br />
    In today's rapidly evolving financial landscape, organizations need professionals who can go beyond traditional accounting and financial management to interpret data, assess risks, drive investments, and make strategic business decisions.
    <br />
    <br />
    The MBA in Finance at Tula's Institute, Dehradun is designed to develop analytical, technology-driven, and business-focused finance professionals who can thrive in modern financial ecosystems. With the integration of Artificial Intelligence into financial services, the program equips students with the skills to leverage AI-powered tools for financial forecasting, investment analysis, risk assessment, portfolio management, and business intelligence.
    <br />
    <br />
   Combining strong theoretical foundations with practical industry exposure, the program prepares students to navigate complex financial markets, corporate finance environments, banking systems, and investment landscapes with confidence.
    <br />

    <p
            className="mt-5 leading-[1.1] text-[#111111] max-[600px]:text-[0.95rem]"
            style={{ fontSize: 'clamp(1.3rem, 3vw, 1.2rem)' }}
          >
            Program Overview
          </p>
    <br />
 The MBA in Finance provides comprehensive knowledge of financial management, investment strategies, corporate finance, banking operations, financial markets, and emerging financial technologies. Students learn to analyze financial data, evaluate investment opportunities, manage business risks, and support strategic organizational growth.
    <br />
    <br />
    The curriculum emphasizes practical learning through case studies, simulations, industry projects, internships, and exposure to real-world financial scenarios.
    <br />
    Key areas of study include:
      ...
      <li>
        ...
        <p
            ...
            style={{ fontSize: 'clamp(1.3rem, 3vw, 1.2rem)' }}
          >
            Become the Financial Leaders of Tomorrow
          </p>
    <br />
Build the analytical expertise, strategic decision-making skills, and financial acumen needed to excel in today's dynamic business environment with the MBA in Finance at Tulas Institute, Dehradun, an AI-integrated program designed to prepare future-ready finance professionals, investment specialists, and business leaders.
    <br />
  </>
);
export const items = [
  {
    ...
    image: USP,
    points: [
      "AI-Integrated Finance Curriculum - Learn how Artificial Intelligence is transforming investment analysis, fraud detection, risk management, algorithmic trading, and financial forecasting.",
      "NBA Accredited MBA Program - Benefit from a quality-focused management education aligned with industry standards and academic excellence.",
      "Industry-Relevant Learning - Study emerging trends in corporate finance, FinTech, digital banking, wealth management, and financial analytics.",
      "Practical Exposure - Gain hands-on experience through financial simulations, case studies, internships, and live industry projects.",
      "Expert Faculty & Industry Interaction - Learn from experienced academicians and industry professionals through workshops, guest lectures, and corporate engagements.",
      "Placement-Focused Training - Develop professional competencies through aptitude training, personality development, interview preparation, and career mentoring.",
    ],
  },
  {
    title: "Program Outcomes",
    description: [
      "PO1: Financial Knowledge Application - Apply financial theories, concepts, and management practices to solve business and financial challenges.",
      "PO2: Analytical Thinking - Evaluate financial information and market conditions to support strategic decision-making.",
      "PO3: Business Decision Making - Utilize quantitative and qualitative tools to make informed financial and managerial decisions.",
      "PO4: Leadership & Professional Competence - Demonstrate leadership, teamwork, and managerial capabilities in financial and business environments.",
      "PO5: Technology Integration - Leverage digital technologies, AI tools, and financial analytics platforms to improve business outcomes.",
      "PO6: Ethical Financial Practices - Apply ethical principles and regulatory standards in financial management and decision-making",
      "PO7: Communication & Presentation Skills - Communicate financial insights effectively to stakeholders and business leaders.",
      "PO8: Global Financial Awareness - Understand national and international financial systems, economic trends, and market dynamics.",
    ],
    image: Program,
  },
  {
    ...
    description: [
      "PSO1: Corporate Financial Management - Analyze and manage organizational finances, capital structures, and investment decisions.",
      "PSO2: Investment & Portfolio Analysis - Evaluate investment opportunities and develop effective portfolio management strategies.",
      "PSO3: Financial Risk Assessment - Identify, analyze, and mitigate financial risks using modern risk management frameworks.",
      "PSO4: Banking & Financial Services Expertise - Understand banking operations, financial products, regulatory systems, and financial service management.",
      "PSO5: Financial Analytics & AI Applications - Utilize AI-driven financial tools, predictive analytics, and business intelligence systems to enhance financial performance.",
      "PSO6: Strategic Financial Planning - Develop long-term financial strategies that support business growth, sustainability, and profitability.",
    ],
    image: Course,
  },
...
export const selectedCard1 = (
  <>
    <span className="font-[montserrat] pb-[1%] leading-tight">
      Eligibility Criteria
    </span>
    <p className="mb-3 leading-tight text-[clamp(10px,4vw,30px)] md:text-[clamp(10px,1.1vw,45px)] text-[#353535]">Candidates seeking admission must fulfill the following requirements:</p>
