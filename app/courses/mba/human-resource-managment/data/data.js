...
export const content = (
  <>
    AI-Integrated MBA | NBA Accredited Program | Industry-Driven Curriculum | Future-Ready HR Leaders
    <br />
    <br />
    At Tula's Institute, Dehradun, the MBA in Human Resource Management is designed for students who aspire to become strategic people leaders in a rapidly evolving workplace. As organizations embrace digital transformation, HR professionals are no longer limited to recruitment and employee management—they are expected to drive culture, performance, workforce analytics, talent strategy, and organizational growth.
    <br />
    <br />
    Our AI-Integrated MBA in Human Resource Management combines traditional HR expertise with emerging technologies, enabling students to leverage AI-powered tools for recruitment, workforce planning, employee engagement, performance management, and data-driven decision-making.
    <br />
    <br />
    Backed by experienced faculty, industry interactions, live projects, internships, and practical learning experiences, the program prepares graduates to excel in corporate HR, talent acquisition, learning and development, employee relations, HR analytics, and strategic workforce management.
    <br />
  </>
);
export const items = [
  {
    ...
    image: USP,
    points: [
      "AI-Driven HR Learning - Gain exposure to AI-powered recruitment platforms, workforce analytics tools, talent intelligence systems, and predictive HR technologies.",
      "Industry-Relevant Skill Development - Develop practical competencies in interviewing, conflict resolution, leadership coaching, employee engagement, and performance evaluation.",
      "Corporate Exposure - Interact with HR professionals, business leaders, and industry experts through guest lectures, seminars, and workshops.",
      "Live Projects & Internships - Work on real-world business and HR challenges to gain practical industry experience.",
      "Placement-Focused Ecosystem - Benefit from dedicated training initiatives, mock interviews, aptitude preparation, and career development support.",
    ],
  },
  {
    title: "Program Outcomes",
    description: [
      "PO1: Managerial Knowledge - Apply management theories and business principles to solve organizational challenges.",
      "PO2: Critical Thinking - Analyze business situations and develop strategic solutions using data and evidence-based approaches.",
      "PO3: Effective Decision Making - Make informed managerial decisions in dynamic business environments.",
      "PO4: Leadership & Team Management Lead diverse teams while fostering collaboration, innovation, and organizational effectiveness.",
      "PO5: Technology Integration - Utilize digital tools, AI applications, and business technologies for organizational success",
      "PO6: Ethical & Responsible Management - Demonstrate ethical leadership and socially responsible business practices.",
      "PO7: Communication Excellence - Communicate effectively with stakeholders across organizational levels.",
      "PO8: Global Business Perspective - Understand global business environments and workforce challenges.",
    ],
    image: Program,
  },
  {
    ...
    description: [
      "PSO1: Strategic HR Management - Design and implement effective HR strategies aligned with organizational objectives.",
      "PSO2: Talent Acquisition & Workforce Planning - Develop expertise in recruitment, talent management, succession planning, and workforce optimization.",
      "PSO3: Employee Engagement & Performance Management - Create systems that improve employee productivity, engagement, and retention.",
      "PSO4: HR Analytics & AI Applications - Leverage HR analytics, AI-powered tools, and workforce data for strategic decision-making.",
      "PSO5: Organizational Development - Facilitate organizational change, leadership development, and culture-building initiatives.",
      "PSO6: Legal & Ethical Compliance - Apply labor laws, industrial relations principles, and ethical HR practices effectively.",
    ],
    image: Course,
  },
