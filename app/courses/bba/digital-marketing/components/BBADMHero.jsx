...
const PILLS = [
  ...
  { bold: null,            rest: 'Live Brand Projects'    },
  { bold: null,            rest: 'Industry Certifications' },
  { bold: 'Up to ₹60 LPA',rest: ' Highest Package'      },
];

export default function BBADMHero() {
  return (
    <>
      <style dangerouslySetInnerHTML={{__html:`
        @keyframes cl-dm-zoom{from{transform:scale(1)}to{transform:scale(1.08)}}
        .cl-dm-bg img{width:100%;height:100%;object-fit:cover;animation:cl-dm-zoom 20s ease-in-out infinite alternate}
      `}} />
      ...
      >
        {/* Background image */}
        <div className="cl-dm-bg absolute inset-0 z-0">
          <img src="/courses/bba/bannerImg.webp" alt="BBA Digital Marketing at Tulas" />
        </div>
        ...
        <div className="relative z-[5] text-center py-[50px] px-[7%] max-w-[1200px] w-full">
          ...
          >
            Home / Programs / BBA / <span style={{ color: '#FFF3D7' }}>Digital Marketing</span>
          </div>
          ...
          >
            Master modern marketing with an AI-integrated BBA in Digital Marketing. Learn branding, social media, performance marketing, content creation, analytics, e-commerce and AI-powered marketing while building real campaigns for real businesses.
          </p>
