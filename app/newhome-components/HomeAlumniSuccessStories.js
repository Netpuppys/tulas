    ...
    <section className="w-full py-12">
      ...
      <div className="px-4 md:px-12">
        ...
        <p className="text-gray-600 text-sm text-center md:text-base mb-8">
          At Tulas Institute, practical learning, industry exposure, and career support prepare students for real-world opportunities. Our alumni work across industries such as IT and software development, banking and finance, pharmaceutical and healthcare, e-commerce, and emerging sectors like startups and analytics.
        </p>
      </div>
