...
export default function TopRecruiters() {
  return (
    <div className="w-full py-12 px-4 md:px-12">
      <h2 className="text-3xl md:text-4xl font-bold text-center text-[#f97316] mb-10">
        TOP RECRUITERS
      </h2>
      ...
      <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6 gap-6">
        {recruiters.map((r, idx) => (
          <div
            key={idx}
            className="bg-white aspect-square flex items-center justify-center rounded-lg border border-[#045] shadow-md hover:shadow-[8px_8px_0px_0px_#f97316] transition-shadow duration-300"
          >
            <img
              src={r.src}
              alt={r.name}
