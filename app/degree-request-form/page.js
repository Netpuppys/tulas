    ...
    <>
      ...
      <div className="w-full relative overflow-hidden">
        ...
        <div className="py-10 md:py-20">
          ...
          <ul className="list-disc text-white font-[TTChocolates] w-[90%] max-w-[1200px] px-2 text-[14px] md:text-[25px] mx-auto">
            <li>
              <strong>Payment of mailing fee:</strong> A nominal fee of Rs 800/-
              (Eight Hundred Only) for domestic and Rs  2300/- (Two thousand
              three Hundred only) where 300 is the degree fee and rest
              for  International postage and handling of your degree will be
              applicable. Payment instructions  have been given in the Degree
              Request Form. Please make the necessary payment to the  college
              account shared with the Degree Request Form and confirm the
              payment by attaching  the receipt with the form. Once the payment
              is confirmed, your degree will be dispatched.
            </li>
            <br />
            <li>
              ...
              address.  Please keep this information safe for future reference.
            </li>
            <br />
            <li>
              <strong>Estimated delivery time:</strong>
              In most cases, domestic deliveries can be expected within
              5-10  business days, while international shipments may take longer
              due to customs and local postal  services.
            </li>
            <br />
            <li>
            ...
            <li>
              ...
              damaged  during transit, please contact the administration office
              immediately. We will initiate the  necessary procedures for
              re-issuing your degree or resolving any issues that may arise.
            </li>
          </ul>
        </div>
      </div>
