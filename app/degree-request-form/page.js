      ...
      <body>
        ...
        <div className="w-full relative overflow-hidden">
          ...
          <div className="py-10 md:py-20">
            ...
            <ul className="list-disc leading-tight text-[clamp(15px,4.2vw,30px)] md:text-[clamp(10px,1.1vw,45px)] text-white font-[TTChocolates] w-full max-w-[1200px] mx-auto px-8">
              <li>
