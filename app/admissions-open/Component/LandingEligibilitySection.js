    ...
    <section className="w-full mt-12 py-6 bg-white flex justify-center">
      <div className="w-full max-w-6xl px-3">
        ...
        <div className="flex flex-col md:flex-row gap-8 md:items-stretch">
          ...
          {/* CTA SECTION */}
<div className="md:w-1/2 w-full flex">
  <div className="bg-orange-500 rounded-[28px] px-6 py-10 text-center text-white w-full h-full flex flex-col justify-center">

    <h4 className="text-[22px] md:text-4xl font-light leading-relaxed space-y-2">
      <div>Shape Your Future</div>

      <div className="font-bold text-[36px]">Career</div>

      <div>Step Into New</div>

      <div className="font-bold text-[36px]">Opportunities</div>
    </h4>
    ...
    <button
      ...
      className="bg-[#f3d1b2] text-gray-900 px-8 py-2 mt-6 rounded-full text-lg font-medium shadow-xl hover:scale-105 transition"
    >
