  ...
  return (
    <>
      ...
      <div className="w-full h-fit bg-white">
        <div className="py-20 px-2 max-w-[1000px] mx-auto">
          ...
          <div className="flex pt-10 mx-auto w-fit justify-center items-center h-fit gap-10">
          ...
          <div className="flex w-full mx-auto pt-10 gap-10">
            <div className="w-full">
              <button
                onClick={() => handleButtonClick("academic")}
                className="font-[TTChocolatesBold] mb-8 bg-[#760135] rounded-full text-white text-[18px] md:text-[24px] text-center items-center py-2 w-full"
              >
                Pay Academic Fee
              </button>
                ...
                <div className="w-full">
                  <div className="w-full flex flex-col justify-center items-center gap-2">
                    <button
                      ...
                      className="font-[TTChocolatesBold] bg-[#760135] rounded-full text-white text-[16px] text-center items-center py-2 w-full"
                    >
