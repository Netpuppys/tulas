...
export const semesterData = [
  {
    ...
    subjects: [
      ...
      { code: "991007", title: "General Workshop Practice-1" },
...

  {
    ...
    subjects: [
      { code: "53001", title: "Internet of Things" },
      { code: "53002", title: "Data Communication" },
      { code: "53003", title: "Digital Techniques" },
      { code: "53004", title: "Office Application" },
      { code: "53005", title: "Operating System" },
      { code: "53006", title: "Programming in C" },
      {
        code: "53052",
        title: "Industrial Exposure (Assignment at Institute Level)",
      },
      { code: "53054", title: "General Proficiency #" },
    ],
  },

  {
    ...
    subjects: [
      { code: "54001", title: "Computer Network and Security" },
      { code: "54002", title: "Computer System Organization and Architecture" },
      { code: "54003", title: "Data Structure Using C" },
      { code: "54004", title: "Internet and Web Technology" },
      { code: "54005", title: "Relational Database Management System" },
      { code: "54006", title: "Object Oriented Concepts" },
      {
        code: "54052",
        title: "Industrial Exposure (Assessment at Institute Level)+",
      },
      { code: "14054", title: "General Proficiency #" },
      { code: "54053", title: "Industrial Training" },
    ],
  },

  {
    semester: "V SEMESTER",
    subjects: [
      { code: "55001", title: "Java Programming" },
      { code: "55002", title: "Software Engineering" },
      { code: "55003", title: "Computer Hardware and Servicing" },
      { code: "55004", title: "Android Application Development" },
      { code: "55005", title: "Minor Project Work" },
      {
        code: "55052",
        title: "Industrial Exposure (Assessment at Institute Level) +",
      },
      { code: "55053", title: "Industrial Training" },
      { code: "15054", title: "General Proficiency" },
    ],
  },

  {
    ...
    subjects: [
      { code: "56003", title: "Multimedia System" },
      { code: "56001", title: "Concept of .NET Technology" },
      { code: "56002", title: "Data Mining & Warehousing" },
      { code: "56004", title: "Open Source Technology" },
      { code: "56005", title: "Major Project" },
      {
        code: "56052",
        title: "Industrial Exposure (Assessment at Institute Level) +",
      },
      { code: "16054", title: "General Proficiency" },
      { code: "16055", title: "Employability Skills" },
    ],
  },
];
