    ...
    <div className="w-full px-4 md:px-10 py-6">
      <div className="max-w-[1200px] mx-auto">
        ...
        <div className="relative rounded-xl overflow-hidden border border-[#7B1F4B] shadow-lg">
          ...
          <iframe
            src="https://docs.google.com/spreadsheets/d/e/2PACX-1vSBKPOOfj3CNTfcv7o3fObHitzKNciKJ0ST7pjfLFtqSMhDU5TxQu99iTdZMGOlvUPEUFH6x4TQixAa/pubhtml?gid=1528885869&amp;single=true&amp;widget=true&amp;headers=false"
