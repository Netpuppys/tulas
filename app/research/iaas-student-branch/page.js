      ...
      description: (
        <>
          <ul className="ml-5 list-disc">
            ...
            <br />
            <li>
              <strong>Skill Development:</strong> The Tulas IAAS chapter
            ...
            <br />
            <li>
              <strong>International Cooperation:</strong> Tulas IAAS promotes
              international collaboration and understanding by fostering
              connections with students and organizations from different
              countries. The chapter at Tulas Institute actively participates
            ...
            <br />
            <li>
              <strong>Community Outreach:</strong> The Tulas IAAS chapter
            ...
            <br />
            <li>
              <strong>Leadership and Personal Development:</strong> The Tulas
          ...
          <br />
          Through its IAAS chapter, Tulas Institute promotes a global
      ...
      <body>
        ...
        <div className="flex flex-col items-center overflow-hidden">
          <Banner
            ...
            title={
              <>
                IAAS <span className="text-[#f97316]">Student Branch</span>
              </>
            }
            description={<></>}
            belowTitle={<></>}
            belowPara={
              <>
                Tulas University is proud to host the International Association
                ...
                <br />
                <br />
                The Tulas IAAS chapter at Tulas University provides a platform
                ...
                <br />
                <br />
                Some key objectives and activities of the Tulas IAAS chapter at
                Tulas University include:
              </>
            }
          />
