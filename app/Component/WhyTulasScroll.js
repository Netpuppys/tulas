                ...
                <div className="flex w-fit h-fit gap-12">
                  {images.map((image, index) => (
                    ...
                    >
                      ...
                      <div className="text-white md:hidden group-hover:flex flex-col absolute z-30 w-fit p-2 bottom-[42px] translate-y-[100%]">
                        <h2 className="text-center font-[TTChocolatesBold] text-[clamp(15px,4.5vw,30px)] md:text-[clamp(18px,1.3vw,45px)]">
                          {image.title}
                        </h2>
                        <h6 className="font-[TTChocolates] text-center text-[clamp(15px,4.2vw,30px)] md:text-[clamp(10px,0.9vw,45px)]">
                          {image.text}
                        </h6>
                      </div>
                    </div>
