                  ...
                  {images.map((image, index) => (
                    ...
                    >
                      ...
                      <div className="text-white flex flex-col absolute z-30 w-fit p-2 bottom-[42px] translate-y-[100%]">
                        <h2 className="text-center font-[TTChocolatesMedium] leading-tight text-[clamp(10px,4.2vw,30px)] md:text-[clamp(10px,1.1vw,45px)]">
                          {image.title}
                        </h2>
                        <h6 className="font-[TTChocolates] md:hidden group-hover:block text-center text-[clamp(10px,4vw,30px)] md:text-[clamp(10px,1vw,45px)] leading-tight">
                          {image.text}
                        </h6>
                      </div>
                    </div>
