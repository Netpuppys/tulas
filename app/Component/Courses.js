...
function Courses({ parentRef }) {
  ...
  return (
    <div ref={childRef} className="w-full h-fit">
      <div className="w-full h-[4900px] md:h-[262vh] relative bg-[#3D001B] overflow-hidden">
        <div
          className={`${
        ...
        >
          <h3 className="font-[Dynalight] text-[40px] leading-none md:text-[clamp(10px,3vw,120px)] text-white z-20 text-center md:leading-[5.8vw]">
            Our
            <br />
        ...
        >
          ...
          <h5
            className={`w-full px-4 max-w-[50rem] text-white font-[TTChocolates] leading-tight leading-tight text-[clamp(10px,4vw,30px)] md:text-[clamp(10px,1.1vw,45px)] text-center transition-opacity duration-300 ease-in-out ${
