            ...
            >
              <div className="w-full text-[#353535] md:w-full px-4 md:px-0">
                ...
                <h5 className="w-full text-[#353535] md:w-full text-justify mx-auto leading-tight text-[clamp(10px,4vw,30px)] md:text-[clamp(10px,1vw,45px)] font-[MontserratLight] font-normal">
                  ...
                  program aimed at professionals and students looking to deepen
                  their expertise in engineering and technology. This advanced
                  degree offers a robust curriculum that integrates theoretical
                  concepts with practical applications, focusing on specialized
                  knowledge, research methodologies, and industry-driven
                  innovations.
                  ...
                  with cutting-edge skills, ensuring they remain competitive in
                  the rapidly evolving technological landscape.
                  <div className="mt-4 md:mt-[1%]"></div>
                  One of the key aspects of an M.Tech degree is its emphasis on
                  research and development (R&D). Students engage in thesis
                  work, innovative projects, and industrial collaborations that
                  foster independent thinking and innovation. Many universities
                  and institutes have dedicated research centers where students
                  work on breakthrough technologies, patents, and solutions for
