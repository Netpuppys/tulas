...
import bannerImg from "../../../public/landingbanner/bca/bcamobile.jpg";
import bannerImgDesktop from "../../../public/landingbanner/bca/bcadesktop.jpg";
...
const placementSlides = [
  ...
  return (
    <>
      <head>
        <title>Tula's Institute is best to pursue a career in BCA</title>
        <meta
          name="description"
