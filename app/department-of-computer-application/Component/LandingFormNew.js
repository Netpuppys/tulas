...
const CENTER_NAMES = {
  21: "BCA",
  126: "BCA - AIML",
  127: "BCA - Cybersecurity",
  128: "BCA - Full Stack Development",
};

function McaLandingForm({
  course,
  thankYOu,
  formHeading,
  showCourse = false,
...
>
  ...
  <option value="128">BCA - Full Stack Development</option>
            ...
            <button
              ...
              className={`w-full xl:w-[40%] mx-auto bg-orange-500 text-white cursor-pointer py-2 rounded-[10px] disabled:opacity-100 disabled:cursor-not-allowed font-semibold`}
            >
              Submit
            </button>
          </form>
