...
export default function SpecialisationsCarousel() {
  ...
  const alumniCards = [
    "/btechimage/roles/role1.png",
    "/btechimage/roles/role2.png",
    "/btechimage/roles/role3.png",
    "/btechimage/roles/role4.png",
    "/btechimage/roles/role5.png",
    "/btechimage/roles/role6.png",
    "/btechimage/roles/role7.png",
    "/btechimage/roles/role8.png",
  ];
    ...
    <section className="w-full py-12">
      ...
      <div className="px-4 md:px-12">
        <h3 className="text-[clamp(38px,6vw,36px)] text-center font-extrabold mb-3">
          <span className="text-orange-500">Turn Creativity</span>{" "}
          <span className="text-gray-800">Into Careers</span>
        </h3>
