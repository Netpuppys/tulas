...
const BG_IMAGE = '/campus-life/newncc/img12.jpg';
    ...
    <>
      ...
      >
        ...
        <div className="relative z-[5] text-center px-[7%] max-w-[1100px] cl-fo-fadein">
          ...
          >
           At Tula's, leadership is shaped through responsibility, teamwork, service and real-world experiences. We build character, discipline and purpose through action-driven learning.
          </p>
