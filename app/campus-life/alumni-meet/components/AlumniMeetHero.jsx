...
const BG_IMAGE = '/campus-life/leadershipfest/img18.jpg';

const FLOATS = [
  { icon: '🎓', label: <><strong>Alumni</strong> 5000+</>,    pos: 'top-[18%] left-[8%]',    delay: '0s'  },
  { icon: '🤝', label: <><strong>Connections</strong> Growing</>,   pos: 'top-[22%] right-[10%]',  delay: '-2s' },
  { icon: '✨', label: <><strong>Focus</strong> Character Building</>,     pos: 'bottom-[22%] left-[12%]', delay: '-4s' },
  { icon: '🌟', label: <><strong>Industries</strong> 50+</>,        pos: 'bottom-[18%] right-[8%]', delay: '-3s' },
];

export default function LeadershipFestHero() {
  return (
    <>
      ...
      >
        ...
        <div className="relative z-[5] text-center px-[7%] max-w-[1100px] cl-fo-fadein">
          ...
          >
           At Tula's, friendships, memories and experiences continue long after graduation. No matter where life takes you, a part of the journey always stays here.
          </p>
