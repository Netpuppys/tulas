...
function Vibgyor() {
  const sections = [
    ...
    {
      title: "Expresso",
      description: "Public speaking and anchoring talents are honed in Expresso. This club provides opportunities for students to develop their oratory skills and confidently take the stage as anchors.",
    ...
    <div>
      ...
      <div className="bg-white w-full h-fit flex flex-col justify-center  items-center py-8 md:py-20">
        ...
        <p className="text-lg md:text-2xl w-[90%] md:w-[70%] font-[TTChocolates] mx-auto text-center text-black">
          ...
          is the heart and soul behind the extra and co-curricular activities on
          campus. This dedicated body ensures students have a holistic and
