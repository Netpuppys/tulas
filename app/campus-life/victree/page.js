    ...
    <div>
      ...
      <div className="bg-white w-full h-fit flex flex-col justify-center  items-center py-8 md:py-20">
        ...
        <p className="text-lg md:text-2xl w-[90%] md:w-[70%] font-[TTChocolates] mx-auto text-center text-black">
          ...
          is where athletic passion meets unparalleled dedication. This dynamic
          club is at the heart of promoting physical fitness, teamwork, and
          sportsmanship among students. Whether you're an enthusiastic athlete
          or just looking to stay active, Victree offers a plethora of indoor
          and outdoor games to cater to all interests and skill levels.
        </p>
      </div>
      ...
      <div className="bg-white w-full h-fit flex flex-col justify-center  items-center py-8 md:py-20">
        <p className="text-lg md:text-2xl w-[90%] md:w-[70%] font-[TTChocolates] mx-auto text-center text-black">
          ...
          fosters a sense of community and camaraderie among students. Our club
          regularly organizes tournaments, practice sessions, and friendly
          matches to keep the competitive spirit alive and ensure that every
          student can pursue their athletic interests.
        </p>
      </div>
