...
import bannerImg from "../../../public/school-of-law/bballbmobile.jpg";
import bannerImgDesktop from "../../../public/school-of-law/bballbdesktop.jpg";
...
import BbaLandingReadmore from "../Component/BbaLandingReadMore";
import BbaLandingWhyTulas from "../Component/BbaLandingWhyTulas";
import BbaLandingAccordianSpecialization from "../Component/BbaLandingAccordianSpecialization";
...
import Bballbcoredomain from "../Component/Bballbcoredomain";
// images
const page = () => {
...
const placementSlides = [
  ...
  return (
    <>
      <head>
        <title>Tula's Institute is best to pursue a career in BBA LLB</title>
        <meta
          name="description"
          content="Join Tula's Institute. Excel in BBA LLB and more with industry-focused programs and dedicated faculty. Become a future leader today"
        />
      </head>
      <body>
