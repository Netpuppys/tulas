    ...
    <section className="w-full py-6 bg-white">
      ...
      <div className="w-full max-w-4xl md:max-w-7xl px-5 mx-auto">
        ...
        <h2 className="text-center text-[clamp(36px,5vw,38px)] font-medium mb-6">
          ...
          <span className="text-gray-800 font-extrabold">Tulas BBA LL.B (Hons.)?</span>
        </h2>

        {/* Description */}
        <p className="text-gray-600 text-[15px] md:text-[17px] leading-relaxed text-center mb-10">
          The program focuses on building strong legal and business understanding with practical exposure. Students are trained in legal research, drafting, corporate compliance, and communication skills essential for modern legal professionals. With exposure to case studies, moot courts, internships, and business scenarios, students gain clarity in applying legal knowledge within corporate and professional settings.
