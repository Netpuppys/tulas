    ...
    <section className="w-full py-6 bg-white">
      ...
      <div className="w-full max-w-4xl md:max-w-6xl px-5 mx-auto">
        ...
        <h2 className="text-center text-[clamp(36px,5vw,38px)] font-medium mb-6">
          ...
          <span className="text-gray-800 font-extrabold">Tulas LLB?</span>
        </h2>

        {/* Description */}
        <p className="text-gray-600 text-[15px] md:text-[17px] leading-relaxed text-center mb-10">
         The LLB program at Tulas College focuses on building practical skills and professional readiness. Students are trained in legal research, drafting, advocacy, and communication—essential for both courtroom and corporate environments. With regular exposure to case studies, moot courts, and internships, students gain confidence and clarity in applying legal knowledge in real situations.
        </p>
