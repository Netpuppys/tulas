...
export default function BcomLandingWhyTulas() {
    ...
    <section className="w-full py-6 bg-white">
      ...
      <div className="w-full max-w-4xl md:max-w-7xl px-5 mx-auto">
        ...
        <h2 className="text-center text-[clamp(36px,5vw,38px)] font-medium mb-6">
          ...
          <span className="text-gray-800 font-extrabold">Tulas BA LL.B (Hons.)?</span>
        </h2>

        {/* Description */}
        <p className="text-gray-600 text-[15px] md:text-[17px] leading-relaxed text-center mb-10">
          The program focuses on building a strong understanding of law in relation to society and governance. Students are trained in legal research, drafting, advocacy, and analytical thinking skills essential for litigation, judiciary, and public policy roles. With regular exposure to case studies, moot courts, internships, and social-legal contexts, students gain clarity in applying legal principles in real-world scenarios.
...
<div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-10 max-w-3xl mx-auto">
  ...
  <div className="flex items-center gap-3 text-2xl font-medium text-black">
    ...
    <span className="text-orange-500 font-bold">BCI</span> Approved
  </div>
  ...
  <div className="flex items-center gap-3 text-2xl font-medium text-black">
    <IoCheckmarkSharp className="text-2xl text-orange-500" />
    <span className="text-orange-500 font-bold">Legal</span> Simulations
  </div>
