  ...
  <div className="max-w-6xl mx-auto px-4">
    <div className="flex flex-col md:flex-row items-center gap-10">
      ...
      <h3 className="text-center text-[clamp(38px,5.5vw,34px)] font-extrabold mb-4">
        <span className="text-orange-500">Legal Internships</span>{" "}
        <span className="text-gray-800">& Exposure at Tulas</span>
      </h3>

        <p className="text-[#6b7280] leading-relaxed text-base md:text-lg">
          The Training and Placement Cell at Tulas supports law students in preparing for professional opportunities across litigation, corporate law, and legal services through structured training, internship support, and career guidance. With a focus on legal drafting, research skills, communication, moot court practice, and interview preparation, students gain the confidence and exposure needed to begin their legal careers

        </p>
        <br/>
        <p className="text-[#6b7280] leading-relaxed text-base md:text-lg">
          Complementing this is TCCI (Tulas Career Catalyst Initiative), a professional capability framework designed to bridge the gap between academic learning and real legal practice. Through assessments, targeted training, practical simulations, and moot court exercises, it helps students develop the skills and readiness required to perform effectively from the start of their careers
        </p>
      </div>
