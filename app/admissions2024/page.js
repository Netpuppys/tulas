        ...
        <div className="w-full pb-28">
            ...
            <div className='flex w-full flex-wrap items-center justify-center gap-x-4 gap-y-10 px-24 mt-16'>
                {programsOffered.map((item, index) => (
                    <div className='w-[calc(33%-0.5rem)] rounded-xl h-16 bg-white flex items-center justify-center text-[1.55rem] font-medium text-[#760135]' key={index}>
                        {item}
                    </div>
                ))}
            </div>
        ...
        <div className="flex flex-col items-center justify-start pt-20 pb-24">
            ...
            <div className="flex gap-8 mt-20 relative">
                ...
                {rankings.map((item, index) => (
                    <div key={index} className="flex flex-col items-center justify-start gap-6">
                        <div className={`w-24 relative shadow-[0px_4px_53.3px_5px_rgba(0,0,0,0.8)] group transition-all ease-linear duration-300 aspect-square rounded-full flex items-center justify-center border-2 border-white ${index>2? "bg-transparent backdrop-blur-lg" : "bg-white"}`}>
                            ...
                            <p className={`text-3xl z-10 font-semibold ${index>2? "text-white" : "text-[#3D001B]"}`}>
                                {item.rank}
                            </p>
                        </div>
            ...
            <div className="pb-10 mt-32 w-full flex items-center justify-center px-20 relative">
                <div className="flex w-full max-w-[70rem] items-center justify-center gap-10">
                    <button
                        className="prev-btn border-2 absolute top-1/2 -translate-y-1/2 left-20 border-white rounded-full w-16 aspect-square bg-transparent text-white hover:text-[#007A83] hover:bg-white text-3xl flex items-center justify-center"
                    >
                        <BsArrowLeft />
                    </button>
                    ...
                    <button
                        className="next-btn border-2 absolute top-1/2 -translate-y-1/2 right-20 border-white rounded-full w-16 aspect-square bg-transparent text-white hover:text-[#007A83] hover:bg-white text-3xl flex items-center justify-center"
                    >
                        <BsArrowRight />
                    </button>
                </div>
