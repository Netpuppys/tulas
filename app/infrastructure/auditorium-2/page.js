  ...
  const sections = [
    {
      ...
      description:
        "Tulas University takes pride in exhibiting a state of art auditorium, located at the heart of the campus. It has been constructed keeping in mind the smallest of details and is well equipped with the latest technology. It portraits a perfect example of modern architecture and is certainly one of its kind in the entire Northern India. As a result of the world-class infrastructure Tulas University over the years has been ranked among the ‘Top 10 engineering college in Uttarakhand’.",
  ...
  <NewNavbar fullBanner={true}/>
        ...
        <div className="flex flex-col items-center">
          <Banner
            ...
            title={"AUDITORIUM"}
            belowPara={
              "The auditorium at Tulas University in Dehradun is a modern facility designed to host a variety of events, including seminars, conferences, and cultural programs. It is equipped with state-of-the-art audio-visual technology, providing an ideal environment for both academic and extracurricular activities."
            }
          />
          {/* fixed background */}
