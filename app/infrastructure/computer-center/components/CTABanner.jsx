...
export default function CTABanner() {
  return (
    <section className="bg-[#f26522] py-[72px] max-[600px]:py-12 px-[7%] max-[600px]:px-[4%] relative overflow-hidden">
      {/* Watermark */}
      <span
        className="font-montserrat absolute right-[4%] top-1/2 -translate-y-1/2 font-extrabold text-[8rem] text-white/[0.08] tracking-[-0.04em] pointer-events-none whitespace-nowrap select-none max-[960px]:hidden"
        aria-hidden="true"
      >
        IT LAB
      </span>
      ...
      <div className="relative z-10 grid grid-cols-[1fr_auto] max-[960px]:grid-cols-1 gap-12 max-[960px]:gap-9 items-center">
        ...
        <div>
          ...
          >
            Experience World-Class<br />IT Infrastructure First-Hand
          </h2>
          <p className="text-[0.97rem] text-white/82 leading-[1.65] max-w-[560px]">
            Tulas&apos; Computer Centre is built for the demands of tomorrow. From Software Development
            to AI &amp; ML labs, students get hands-on access to industry-grade tools and technologies
            from day one.
          </p>
