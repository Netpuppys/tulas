...
const FEATURES = [
  {
    ...
    text: 'High-resolution digital projectors, large display screens, and professional-grade microphone systems ensure that every student — from the front row to the back — follows every word and visual with complete clarity.',
  },
  {
    icon: '🪑',
    title: 'Ergonomic, Tiered Seating',
    text: 'Tiered seating arrangements guarantee unobstructed sight-lines to the board and screen for all 70 students, while ergonomic chairs and writing surfaces provide the physical comfort needed for long classroom sessions.',
  },
  {
    icon: '🔊',
    title: 'Superior Acoustics & Lighting',
    text: 'Acoustic panels and optimised room geometry eliminate reverb and echo, while purpose-designed lighting ensures an environment that reduces eye strain and maintains student alertness throughout lectures.',
  },
];
    ...
    <section className="bg-white py-24 max-[960px]:py-16 max-[600px]:py-12 px-[7%] max-[960px]:px-[5%] max-[600px]:px-[4%]">
      <div className="grid grid-cols-2 max-[960px]:grid-cols-1 gap-[72px] max-[960px]:gap-9 items-center">
        ...
        <div>
          ...
          >
            Built for<br />
            <em className="text-[#f26522] not-italic">Interactive Learning</em>
          </h2>

          <p className="text-[0.97rem] leading-[1.78] text-[#6b7280]">
            Every element of the lecture theatre has been thoughtfully planned — from sight-lines and acoustics to lighting and seating — to ensure that students can focus entirely on learning. These halls go beyond the traditional classroom to create an environment where knowledge flows freely between students and faculty.
          </p>
        ...
        <div className="relative">
          ...
          <img
            src="https://tulas.edu.in/_next/static/media/img1.2aadec40.webp"
          ...
          <div className="absolute top-5 left-5 max-[600px]:top-[14px] max-[600px]:left-[14px] bg-[#f26522] text-white rounded-[10px] px-[18px] py-[14px] max-[600px]:px-[14px] max-[600px]:py-[10px] font-montserrat font-extrabold shadow-[0_8px_24px_rgba(242,101,34,0.4)] text-center">
            <div className="text-[1.6rem] max-[600px]:text-[1.3rem] leading-none">70</div>
