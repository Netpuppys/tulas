...
const STATS = [
  { val: '70',     lbl: 'Students per Hall' },
  { val: 'AV',     lbl: 'Advanced Audio-Visual' },
  { val: '100%',   lbl: 'Fully Equipped' },
  { val: 'Top 10', lbl: 'College in Uttarakhand' },
];

export default function HeroSection() {
  return (
    <section className="relative min-h-screen flex flex-col items-stretch overflow-hidden pt-[70px] max-[600px]:pt-[60px]">

      {/* Background image */}
      <div
        className="absolute inset-0 bg-center bg-cover bg-no-repeat"
        style={{ backgroundImage: "url('https://tulas.edu.in/_next/static/media/bannerImgLecture.b3a29637.webp')" }}
      />

      {/* Gradient overlay */}
      <div className="absolute inset-0 bg-gradient-to-t from-black/90 via-black/52 to-black/[0.18]" />
      ...
      <div className="relative z-10 flex-1 flex flex-col justify-end px-[7%] max-[600px]:px-[4%]">
        ...
        >
          Lecture<br />
          <em className="text-[#f26522] not-italic">Theatre</em>
        </h1>

        {/* Description */}
        <p className="text-[1.05rem] max-[600px]:text-[0.9rem] leading-[1.75] text-white/80 max-w-[620px] mb-9 max-[600px]:mb-6">
          Spacious, fully equipped, and uniquely designed — Tulas&apos; lecture theatres seat 70 students in complete comfort, with advanced audio-visual aids and an environment built to make every hour of learning more engaging and productive.
        </p>
