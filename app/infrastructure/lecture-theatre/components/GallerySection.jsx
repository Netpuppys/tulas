...
const IMAGES = [
  { src: 'https://tulas.edu.in/_next/static/media/img4.f49ae192.webp', alt: 'Lecture theatre overview',  objectPosition: 'center' },
  { src: 'https://tulas.edu.in/_next/static/media/img1.2aadec40.webp', alt: 'Seating arrangement',       objectPosition: 'center' },
  { src: 'https://tulas.edu.in/_next/static/media/img2.dcc1f42b.webp', alt: 'AV equipment setup',        objectPosition: 'center' },
  { src: 'https://tulas.edu.in/_next/static/media/img3.0c27ce26.webp', alt: 'Theatre interior design',   objectPosition: 'center' },
  { src: 'https://tulas.edu.in/_next/static/media/img4.f49ae192.webp', alt: 'Classroom in session',      objectPosition: 'right' },
];
