...
const STATS = [
  { val: '70',     lbl: 'Seats per Theatre' },
  { val: '100%',   lbl: 'AV Equipped' },
    ...
    <div className="bg-[#111111] py-[60px] max-[600px]:py-11 px-[7%] max-[600px]:px-[4%]">
      <div className="grid grid-cols-4 max-[600px]:grid-cols-2">
        {STATS.map((s, i) => (
          <div
            key={i}
            className="text-center py-[10px] max-[600px]:py-3 max-[600px]:px-2 border-r border-white/[0.08] last:border-r-0 max-[600px]:[&:nth-child(2)]:border-r-0 max-[600px]:[&:nth-child(3)]:border-t max-[600px]:[&:nth-child(3)]:border-t-white/[0.08] max-[600px]:[&:nth-child(4)]:border-t max-[600px]:[&:nth-child(4)]:border-t-white/[0.08]"
          >
