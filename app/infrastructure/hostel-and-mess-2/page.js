  ...
  const sections = [
    {
      ...
      description: (
        <>
          ...
          enrichment of the character and personality of inmates. Tulas
          University is known for being the best engineering college in Dehradun
      ...
      <body>
        ...
        <div className="flex flex-col items-center overflow-hidden">
          <Banner
            ...
            belowTitle={<></>}
            belowPara={
              "Tulas University is one of the best engineering colleges in Dehradun, which provides the best hostel life; the hostel atmosphere forms an essential part of the young budding engineers and management graduates. 6 hostels are located in Tulas campus, out of which 4 are boy’s hostels and 2 are girl’s hostels. Each room is on twin sharing; rooms are spacious, ventilated, airy, and well lit."
            }
          />
          {/* fixed background */}
