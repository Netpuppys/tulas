...
const IMAGES = [
  { src: "/infrastructure/library/gallery.jpg",  alt: 'Library main hall',   objectPosition: 'center' },
  { src: "/infrastructure/library/2image.jpg", alt: 'Reference section',   objectPosition: 'center' },
  { src: "/infrastructure/library/library2.png",   alt: 'NPTEL corner',        objectPosition: 'center' },
  { src: "/infrastructure/library/library.png",  alt: 'Study area',          objectPosition: 'right' },
  { src: "/infrastructure/library/mainbanner.jpg", alt: 'Book stacks',         objectPosition: 'left' },
  { src: "/infrastructure/library/3image.jpg", alt: 'Book stacks',         objectPosition: 'left' },
