...
const STATS = [
  { val: '60,000+', lbl: 'Book Volumes' },
  { val: '18,383+', lbl: 'E-Books' },
  { val: '3,338+',  lbl: 'E-Journals' },
  { val: '448 m²',  lbl: 'Reference Area' },
];
...
<section className="relative min-h-screen md:min-h-[90vh] flex flex-col items-stretch overflow-hidden pt-[70px] max-[600px]:pt-[60px]">
      ...
      <div
        ...
        style={{ backgroundImage: "url('/infrastructure/library/mainbanner.jpg')" }}
      />
      ...
      <div className="relative z-10 flex-1 flex flex-col justify-end px-[7%] max-[600px]:px-[4%]">
        ...
        <p className="text-[1.05rem] max-[600px]:text-[0.9rem] leading-[1.75] text-white/80 max-w-[600px] mb-9 max-[600px]:mb-6">
          With over 60,000 volumes and a cutting-edge digital wing, the Tulas Library is the heart of the institution — a constantly evolving powerhouse of knowledge serving students, faculty, and researchers alike.
        </p>
