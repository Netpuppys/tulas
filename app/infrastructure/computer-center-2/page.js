...
function ComputerScience() {
  const sections = [
    ...
    },
    {
      ...
      description: (
        <>
          Tulas University has an Exclusive Software Development Cell equipped
          ...
          development for administration of the University is delegated as live
          projects to the students, who gain comprehensive practical experience
          on computer applications and software development.
          <br />
          The University visualizes centralized computing facility, campus wide
          ...
          <Banner
            ...
            belowPara={
              <p>
                ...
                millennium, and Tulas University is poised to break new ground
                ...
                button. Having understood the importance, Tulas University has
