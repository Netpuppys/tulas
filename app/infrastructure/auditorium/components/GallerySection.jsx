...
const IMAGES = [
  { src: 'https://tulas.edu.in/_next/static/media/biggestAuditorium.33536442.png', alt: 'Auditorium main hall' },
  { src: 'https://tulas.edu.in/_next/static/media/img1.2971fc59.png',              alt: 'Auditorium stage' },
  { src: 'https://tulas.edu.in/_next/static/media/img2.709bd723.png',              alt: 'Auditorium seating' },
  { src: 'https://tulas.edu.in/_next/static/media/multiUse.4a21bb41.png',          alt: 'Concert hall view' },
  { src: 'https://tulas.edu.in/_next/static/media/img3.f1cbc884.png',              alt: 'Event in progress' },
];
