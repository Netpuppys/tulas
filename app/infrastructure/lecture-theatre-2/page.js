  ...
  const sections = [
    {
      ...
      description:
        "Tulas University is having spacious and fully equipped lecture halls which are unique of their kind, these lecture halls can accommodate 70 students. These are designed to provide complete comfort for the intense hours of the classroom teaching and interaction.",
      image: lecture,
    },
  ];
...
<div className="block md:hidden">
  <NewNavbar fullBanner={true}/>
        ...
        <div className="flex flex-col items-center">
          <Banner
            image={BannerImg}
            title={<span className="text-[#f97316]">LECTURE THEATRE</span>}
            belowPara={
              "The lecture theatres at Tulas University are spacious and well-equipped with advanced audio-visual aids, offering an optimal setting for interactive learning and discussions. They are designed to facilitate a comfortable and engaging educational experience for students."
            }
          />
          {/* fixed background */}
