...
export async function generateStaticParams() {
  const response1 = await fetch(
    "https://tulas.edu.in/wp-json/wp/v2/posts?page=1&per_page=20"
  );
  const response2 = await fetch(
    "https://tulas.edu.in/wp-json/wp/v2/posts?page=2&per_page=20"
  );
  const response3 = await fetch(
    "https://tulas.edu.in/wp-json/wp/v2/posts?page=3&per_page=20"
  );
