  ...
  return (
    <div className="w-full h-screen bg-white overflow-hidden relative">
      ...
      <div className="relative z-20 w-full h-full flex flex-col justify-center items-center">
        ...
        <h3 className="text-black px-2 font-[Helvetica] font-extrabold text-[clamp(14px,6vw,100px)] md:text-[clamp(20px,2.8vw,100px)] mb-4">
          Thank You for Choosing Tula’s!
        </h3>
        <h5 className="text-black px-2 md:max-w-[35vw] text-[clamp(8px,4vw,100px)] md:text-[clamp(13px,1.1vw,45px)] font-[TTChocolates] text-center mb-4">
        ...
        <h5 className="text-[#007A83] px-2 md:max-w-[35vw] text-[clamp(8px,4vw,100px)] md:text-[clamp(13px,1vw,45px)] font-[TTChocolatesBold] text-center">
