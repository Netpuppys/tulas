  ...
  return (
    <div className="w-full h-screen bg-white overflow-hidden relative">
      ...
      <div className="relative z-20 w-full h-full flex flex-col justify-center items-center">
        ...
        <h5 className="text-[#353535] px-2 md:max-w-[35vw] text-[clamp(8px,4vw,100px)] md:text-[clamp(10px,1vw,45px)] font-[MontserratLight] text-center mb-4">
        ...
        <div className="flex flex-col md:flex-row justify-center items-center gap-4 md:gap-[10vw] mt-[5vh] md:mt-[10vh] mb-4">
          <div className="flex flex-col justify-center items-center gap-4">
            <h3 className="text-[#353535] leading-tight text-[clamp(10px,4vw,30px)] md:text-[clamp(10px,1vw,45px)] font-bold font-[MontserratMedium]">
              Contact With Us
            </h3>
          ...
          <div className="flex flex-col justify-center items-center gap-4">
            <h3 className="text-[#353535] leading-tight text-[clamp(10px,4.2vw,30px)] md:text-[clamp(10px,1.1vw,45px)] font-bold font-[MontserratMedium]">
              Visit Our Website
            </h3>{" "}
            <button
