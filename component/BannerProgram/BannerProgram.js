...
function BannerProgram({ image, title, titleColor, description }) {
  return (
    <div className="w-full z-40 px-4 md:px-16 bg-white">
      ...
      <div className="-mt-[18vh] md:-mt-[10vh] w-[80%] md:w-[50%] z-10 relative">
        <h3 className="text-[38px] leading-none md:leading-normal mb-2 md:mb-0 md:text-[60px] text-black z-10 font-[CarotSlab]">
