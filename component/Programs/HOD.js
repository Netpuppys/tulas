...
function HOD({ hod, HODcontent }) {
  return (
    <>
      ...
      <div className="z-40 bg-transparent h-fit relative pl-4">
        <h5 className="w-full text-white  px-4 mx-auto py-10 md:py-20 text-[16px] md:text-[22px] font-[TTChocolates] font-normal">
          {HODcontent}
        </h5>
      </div>
    </>
