        ...
        >
          ...
          {faculty.resume && (
            <Link
              href={faculty.resume}
              target="_blank"
              className="relative h-[40px] bottom-0 cursor-pointer w-full pointer-events-auto flex gap-3 justify-center items-center bg-[#007A83] group-hover:bg-white text-[clamp(14px,1.1vw,50px)] text-white group-hover:text-[#007A83] font-[TTChocolatesBold] transition-all ease-in duration-300 font-[600]"
            >
              Resume
              <FaRegFilePdf />
            </Link>
