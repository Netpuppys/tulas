...
function FormEnquire({ formPopup }) {
  ...
  const handleSubmit = (e) => {
    ...
    const updatedFormData = {
      ...formData,
      LeadChannel: utmParams ? 26 : 25,
      LeadSource: utmParams ? utmSource || 88 : 2,
  ...
  return (
    <div className="w-full h-full">
      ...
      >
        <h3 className="text-center text-[#404040] text-[clamp(15px,4.5vw,30px)] leading-tight md:text-[clamp(10px,1.5vw,45px)] w-full py-6">
          Enquire Now
        </h3>
        <input
          type="text"
